      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-start bg-black opacity-80 z-10 px-6 sm:px-20 md:px-32 lg:px-40 gap-4">
          ...
          <div className="flex flex-col gap-3 sm:gap-7 w-full" data-aos="fade-left">
            ...
            <span className="text-white text-3xl sm:text-4xl md:text-5xl font-bold uppercase">Us</span>
            <span className="text-white text-xl sm:text-2xl md:text-4xl font-bold uppercase">WELDWELL ENGINEERING COMPANY</span>
          </div>
        </div>
      </div>

      <div className="flex flex-col lg:flex-row px-4 mt-16 gap-8 overflow-hidden">
        <div className="map w-full lg:w-[65%] bg-yellow-200 mb-8" data-aos="fade-right">
          <iframe
        ...
        <div className="adress text-white w-full lg:w-[35%]" data-aos="fade-left">
          <h1 className="capitalize text-2xl font-bold text-[#ce9233]">Contact for help</h1>
          <h1 className="uppercase font-extrabold text-6xl mt-4">Get in touch with us</h1>
          <p className="text-lg font-thin mt-8">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Est, vitae! Lorem ipsum dolor sit amet.
          </p>
          <div className="flex flex-col mt-6" data-aos="fade-left">
            <div className="flex flex-col md:flex-row gap-4 items-center" data-aos="fade-left">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-base font-semibold text-[#797672]">+91 9879708224</p>
                <p className="text-base font-semibold text-[#797672]">+91 9909557874</p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center" data-aos="fade-left">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-base font-semibold text-[#797672]">weldwellengg@yahoo.com</p>
              </div>
            </div>
            <p className="border-t border-gray-800 mt-6 mb-6"></p>
            <div className="flex flex-col md:flex-row gap-4 items-center" data-aos="fade-left">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="text-base font-semibold text-[#797672]">201/16, G.I.D.C, Estate, Panoli</p>
                <p className="text-base font-semibold text-[#797672]">Nr.Tema India, Tel.Ankleshwar. Dist.Bharuch, Gujarat</p>
              </div>
            </div>
            <p className="border-t border-gray-800 mt-6 mb-6"></p>
          </div>
